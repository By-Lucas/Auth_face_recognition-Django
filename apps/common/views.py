...
from face_authentication.decorators import allowed_users
from face_authentication import face_app
from django.http import JsonResponse
from face_authentication import settings
import uuid
import base64
import os
...
class LoginFaceAjaxView(View):
    ...
    def post(self, request):
        ...
        return HttpResponseServerError('Usuário inválido')
